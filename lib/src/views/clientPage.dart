...
import 'package:adminpanel/src/views/productCataloguePage.dart';
...
class _clientPage extends State<clientPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _initializeDrawerImage() async {
    try {
      String? imageName = FirebaseAuth.instance.currentUser!.email;
            ...
            SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  buildAnimatedTile(context, Icons.shopping_cart, "Product Catalogue", productCataloguePage()),
                ],
              ),
            ),
          ],
                    ...
                    return AlertDialog(
                      ...
                      content: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 8),
                          elevatedButtonWidget((){
                            Authentication.deleteClient(context);
                            Navigator.pop(con);
                          }, "Delete")
                        ],
                      ),
